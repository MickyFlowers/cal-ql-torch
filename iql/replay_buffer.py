...
class HDF5ReplayBuffer:
    ...
    def _load_episode(self, episode_file: str) -> Dict:
        ...
        with h5py.File(episode_file, 'r') as f:
            ...
            for t in reversed(range(episode_length)):
                mc_return = ep_data['rewards'][t] + self.discount * mc_return * (1.0 - ep_data['dones'][t])
    ...
    def save_episode(
        ...
        next_ft_obs = np.array([obs['ft_obs'] for obs in episode_buffer.next_observations], dtype=np.float32)
        ...
        with h5py.File(episode_file, 'w') as f:
            ...
            next_img_ds = next_obs_grp.create_dataset('img_obs', shape=(episode_length,), dtype=vlen_dtype)
