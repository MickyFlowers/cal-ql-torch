...
class IQLTrainer:
    ...
    def __init__(self, config, policy, qf, vf):
        ...
        self._total_steps = 0
        self._modules = [self.policy, self.qf, self.target_qf, self.vf]
    ...
    def setup_multi_gpu(self, local_rank: int):
        ...
        self.qf = DDP(
            self.qf, device_ids=[local_rank], output_device=local_rank, broadcast_buffers=False
        )
        self.vf = DDP(
            self.vf, device_ids=[local_rank], output_device=local_rank, broadcast_buffers=False
        )
